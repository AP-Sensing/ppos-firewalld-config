...
%changelog
* Thu Jan 19 2024 Fabian Sauter <fabian.sauter+rpm@apsensing.com> - 1.3.0-1
- Removed port 5001 for the gateway as it is now handled by the backend gRPC

* Wed Jan 31 2024 Fabian Sauter <fabian.sauter+rpm@apsensing.com> - 1.2.0-1
- Removing any modifications made to firewalld during boot
